	...
	return (
		<div className="p-8 space-y-6">
			...
			<div className="space-y-4 mt-8">
				...
				<div className="border-2 border-brand-primary p-4 rounded">
					Border brand-primary
				</div>
				<div className="border-2 border-brand-accent p-4 rounded">
					Border brand-accent
				</div>
				<div className="border-2 border-warning p-4 rounded">
					Border warning
				</div>
			</div>
		</div>
