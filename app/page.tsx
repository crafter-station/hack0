  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center font-mono">
      <div className="text-center">
        <h1 className="text-6xl md:text-8xl font-bold mb-4 text-emerald-400">
          hack0.dev
        </h1>

        <p className="text-xl md:text-2xl mb-8 text-gray-300">
          Hackathons para builders. Like ACC but better.
        </p>
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-emerald-400 hover:bg-emerald-500 text-black font-mono font-bold"
          >
            Submit
          </Button>
        </form>
        ...
        {status && (
          <p
            className={`text-sm mb-8 ${status.includes("Registrado") ? "text-emerald-400" : "text-red-400"}`}
          >
            {status}
          </p>
        )}
