...
const siteConfig = {
	name: "hack0.dev",
	title: "Hackathons y Eventos Tech en Latinoamérica",
	description:
	...
	keywords: [
		...
		"hackathon mexico",
		"hackathon argentina",
		"conferencias tech latam",
		"talleres programacion latam",
		"competencias programacion latam",
		"meetups tech lima",
		"eventos IA latam",
		"workshops tecnologia latam",
		"comunidad tech latinoamerica",
		"desarrolladores latam",
		"startups latam",
		"hackatones latam",
		"eventos developer latam",
	],
};
