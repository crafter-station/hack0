...
interface MyOrganizationCardsProps {
...
const ROLE_CONFIG = {
	...
	follower: { label: "Seguidor", icon: UserPlus, color: "text-muted-foreground" },
};

export function MyOrganizationCards({ organizations }: MyOrganizationCardsProps) {
				...
				return (
					...
					>
						...
						<div className="flex items-center justify-between gap-2 text-[11px] text-muted-foreground">
							...
							<span className={`inline-flex items-center gap-1 ${roleConfig.color}`}>
