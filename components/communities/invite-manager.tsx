...
import { createCommunityInvite, getCommunityInvites, deactivateInvite } from "@/lib/actions/communities";
...
export function InviteManager({ communityId }: InviteManagerProps) {
  ...
  const [roleGranted, setRoleGranted] = useState<"follower" | "member" | "admin">("follower");
    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-3">
            <div>
              ...
              <Select value={roleGranted} onValueChange={(v: any) => setRoleGranted(v)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Administra los enlaces de invitación existentes</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground space-y-0.5">
                          ...
                          {invite.expiresAt && (
                            <div>
                              Expira: {format(new Date(invite.expiresAt), "PPP", { locale: es })}
                            </div>
                          )}
                        </div>
                      </div>
