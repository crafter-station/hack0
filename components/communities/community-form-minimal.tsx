			...
			<div className="flex flex-col md:flex-row gap-6">
				...
				<div className="flex-1 space-y-3">
					...
					<div>
						...
						<div
							className={`flex items-center border border-border rounded-lg bg-muted/30 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-1 ${isImporting ? "input-shimmer" : ""}`}
						>
							<span className="text-sm text-muted-foreground pl-3 pr-1 select-none">
								hack0.dev/c/
							</span>
							<Input
								value={slug}
								...
								required
								className="h-10 text-sm flex-1 border-0 shadow-none focus-visible:ring-0 bg-transparent"
								disabled={isImporting}
							/>
