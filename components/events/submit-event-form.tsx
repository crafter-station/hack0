...
export function SubmitEventForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await createEvent({
      ...
      // organizerName is deprecated - events must have an organizationId
      organizationId: "", // This form should not be used anymore
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg border p-4">
          ...
          <input type="hidden" name="isJuniorFriendly" value={isJuniorFriendly ? "true" : "false"} />
        </div>
      </section>
      ...
      {/* Section: Organizador y ubicación */}
      <section className="space-y-4">
        <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              id="organizerName"
              name="organizerName"
              placeholder="ej. Universidad XYZ, GDG Lima"
            />
          </div>
