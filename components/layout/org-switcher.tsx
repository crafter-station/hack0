...
import { Building2, Crown, Shield, Users, UserPlus, Check, ChevronsUpDown, LayoutGrid, Search, Plus } from "lucide-react";
        ...
        {currentOrg ? (
          <>
            ...
            <span className="hidden sm:inline max-w-[120px] truncate">
              {currentOrg.organization.displayName || currentOrg.organization.name}
            </span>
