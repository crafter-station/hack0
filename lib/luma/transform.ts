...
function detectEventType(
  ...
  if (text.includes("hackathon") || text.includes("hackatón")) return "hackathon";
  ...
  if (text.includes("conference") || text.includes("conferencia") || text.includes("congreso")) return "conference";
  if (text.includes("seminar") || text.includes("seminario")) return "seminar";
  if (text.includes("networking")) return "networking";
  if (text.includes("olympiad") || text.includes("olimpiada")) return "olympiad";
  if (text.includes("competition") || text.includes("competencia")) return "competition";
  if (text.includes("accelerator") || text.includes("aceleradora")) return "accelerator";
  if (text.includes("course") || text.includes("curso")) return "course";
  if (text.includes("certification") || text.includes("certificación")) return "certification";
...
export function transformLumaEvent(
  ...
  return {
    slug,
    name,
    description: cleanDescription(lumaEvent.description_md || lumaEvent.description),
...
export function mergeEventUpdates(
  ...
  const newDescription = cleanDescription(lumaEvent.description_md || lumaEvent.description);
  ...
  const newVenue = lumaEvent.location?.place_name || lumaEvent.location?.address;
