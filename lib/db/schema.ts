...
export const events = pgTable("events", {
  ...
  organizerUrl: varchar("organizer_url", { length: 500 }),
  organizerType: organizerTypeEnum("organizer_type"),
...
export const hackathons = events;
export type Hackathon = Event;
export type NewHackathon = NewEvent;
